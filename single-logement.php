...
<main id="singleLogement" class="container">
    <div> 
        ...
        <h1 class="bold" > Montbéliard - Maison </h1>
        ...
        <div class="wrapper">
            <?php $i=1; foreach($fields['photos'] as $photo){ if($i<8){?>
                ...
                <?php if($i==3){ ?> 
                    <a target=”_blank” href="<?php echo $template_url; ?>/visite/Maison.html" style="position:relative;background-size:cover;background-position:center center;background-image: url(<?php echo $photo['url'] ?>);" class="case-<?php echo $i ?>">
                        <img class="img-360" src="<?php echo $template_url; ?>/img/360.svg" >
                    </a>
                <?php } ?>
        ...
        <div class="d-flex flex-row justify-content-between" style="margin-top:30px;position:relative"> 
            ...
            <div style="width:65%"> 
                ...
                <img style="width:100%" src="<?php echo $template_url; ?>/img/Calendrier.png" >
        ...
        <div class="d-flex flex-row justify-content-between" style="flex-flow: row wrap">
            <div class="one-commentaire"> 
                <div class="photo d-flex flex-row align-items-center"> 
                    <img src="<?php echo $template_url; ?>/img/femme1.jpeg" >
            ...
            <div class="one-commentaire"> 
                <div class="photo d-flex flex-row align-items-center"> 
                    <img src="<?php echo $template_url; ?>/img/homme.jpeg" >
            ...
            <div class="one-commentaire"> 
                <div class="photo d-flex flex-row align-items-center"> 
                    <img src="<?php echo $template_url; ?>/img/femme3.jpeg" >
